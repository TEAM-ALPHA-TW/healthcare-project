...
public class clinicaltrialpage {
    ...
    public clinicaltrialpage(Integer id, String title, String diseaseLabel, String diseasePlaceholder,
            String ageLabel, String agePlaceholder, String searchButton,
            String trialId, String trialName, String disease,
            String location, String status,
            Integer minAge, Integer maxAge,
            String actionButton, String actionRoute,
            String backButton, String backRoute) {
